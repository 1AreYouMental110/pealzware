...
local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		...
		suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/1AreYouMental110/betterrise/main/"..scripturl, true) end)
			...
			local teleportScript = [[
				...
				if shared.VapeDeveloper or shared.VoidDev then
					if isfile('vape/loader.lua') then
						...
						loadstring(game:HttpGet("https://raw.githubusercontent.com/1AreYouMental110/betterrise/main/NewMainScript.lua", true))()
					end
				else
					loadstring(game:HttpGet("https://raw.githubusercontent.com/1AreYouMental110/betterrise/main/NewMainScript.lua", true))()
				end
