...
local function addBlur(parent, notif)
	...
	blur.Image = getcustomasset('pealzware/assets/new/'..(notif and 'blurnotif' or 'blur')..'.png')
...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/1AreYouMental110/pealzware/'..(isfile('pealzware/profiles/commit.txt') and readfile('pealzware/profiles/commit.txt') or 'main')..'/'..select(1, path:gsub('pealzware/', '')), true)
		end)
...
local function profilePath(fileName)
	return 'pealzware/profiles/'..tostring(fileName)
end
...
do
	local res = isfile("pealzware/profiles/color.txt") and loadJson("pealzware/profiles/color.txt")
	if res then
...
components = {
	...
	ColorSlider = function(optionsettings, children, api)
		...
		preview.Image = getcustomasset('pealzware/assets/new/colorpreview.png')
		...
		expand.Image = getcustomasset('pealzware/assets/new/expandicon.png')
		...
		rainbow1.Image = getcustomasset('pealzware/assets/new/rainbow_1.png')
		rainbow1.ImageColor3 = color.Light(uipallet.Main, 0.37)
		rainbow1.Parent = rainbow
		local rainbow2 = rainbow1:Clone()
		rainbow2.Image = getcustomasset('pealzware/assets/new/rainbow_2.png')
		rainbow2.Parent = rainbow
		local rainbow3 = rainbow1:Clone()
		rainbow3.Image = getcustomasset('pealzware/assets/new/rainbow_3.png')
		rainbow3.Parent = rainbow
		local rainbow4 = rainbow1:Clone()
		rainbow4.Image = getcustomasset('pealzware/assets/new/rainbow_4.png')
	...
	Dropdown = function(optionsettings, children, api)
		...
		arrow.Image = getcustomasset('pealzware/assets/new/expandright.png')
	...
	Targets = function(optionsettings, children, api)
		...
		icon.Image = getcustomasset('pealzware/assets/new/targetstab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		...
		optionapi.Players = components.TargetsButton({
			...
			Icon = getcustomasset('pealzware/assets/new/targetplayers1.png'),
			IconSize = UDim2.fromOffset(15, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('pealzware/assets/new/targetplayers2.png'),
		...
		optionapi.NPCs = components.TargetsButton({
			...
			Icon = getcustomasset('pealzware/assets/new/targetnpc1.png'),
			IconSize = UDim2.fromOffset(12, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('pealzware/assets/new/targetnpc2.png'),
	...
	TextList = function(optionsettings, children, api)
		...
		buttonicon.Image = optionsettings.Icon or getcustomasset('pealzware/assets/new/allowedicon.png')
		...
		icon.BackgroundTransparency = 1
		icon.Image = optionsettings.Tab or getcustomasset('pealzware/assets/new/allowedtab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		title.Size = UDim2.new(1, -36, 0, 20)
		...
		addbutton.Image = getcustomasset('pealzware/assets/new/add.png')
	...
	TwoSlider = function(optionsettings, children, api)
		...
		knob.Image = getcustomasset('pealzware/assets/new/range.png')
		...
		arrow.BackgroundTransparency = 1
		arrow.Image = getcustomasset('pealzware/assets/new/rangearrow.png')
...
function mainapi:CreateGUI()
	...
	logo.Image = getcustomasset('pealzware/assets/new/guivape.png')
	...
	logov4.Image = getcustomasset('pealzware/assets/new/guiv4.png')
	logov4.Parent = logo
	...
	settingsicon.Image = getcustomasset('pealzware/assets/new/guisettings.png')
	...
	back.Image = getcustomasset('pealzware/assets/new/back.png')
	...
	settingsversion.Text = 'Pealzware '..mainapi.Version..' '..(
		isfile('pealzware/profiles/commit.txt') and readfile('pealzware/profiles/commit.txt'):sub(1, 6) or ''
	)..' '
	...
	function categoryapi:CreateBind()
		...
		icon.BackgroundTransparency = 1
		icon.Image = getcustomasset('pealzware/assets/new/bind.png')
		...
		bind.MouseEnter:Connect(function()
			...
			icon.Image = getcustomasset('pealzware/assets/new/edit.png')
	...
	function categoryapi:CreateOverlayBar()
		...
		button.AutoButtonColor = false
		button.Image = getcustomasset('pealzware/assets/new/overlaysicon.png')
		...
		icon.Position = UDim2.fromOffset(10, 13)
		icon.BackgroundTransparency = 1
		icon.Image = getcustomasset('pealzware/assets/new/overlaystab.png')
	...
	function categoryapi:CreateGUISlider(optionsettings)
		...
		expandicon.Image = getcustomasset('pealzware/assets/new/expandicon.png')
		...
		knob.BackgroundTransparency = 1
		knob.Image = getcustomasset('pealzware/assets/new/guislider.png')
		...
		local normalknob = getcustomasset('pealzware/assets/new/guislider.png')
		local rainbowknob = getcustomasset('pealzware/assets/new/guisliderrain.png')
		local rainbowthread
...
function mainapi:CreateCategory(categorysettings)
	...
	arrow.BackgroundTransparency = 1
	arrow.Image = getcustomasset('pealzware/assets/new/expandup.png')
	arrow.ImageColor3 = Color3.fromRGB(140, 140, 140)
	arrow.Rotation = 180
	...
	function categoryapi:CreateModule(modulesettings)
		...
		bindicon.Image = getcustomasset('pealzware/assets/new/bind.png')
		...
		bindcover.Image = getcustomasset('pealzware/assets/new/bindbkg.png')
		...
		dots.Image = getcustomasset('pealzware/assets/new/dots.png')
		...
		bind.MouseEnter:Connect(function()
			...
			bindicon.Image = getcustomasset('pealzware/assets/new/edit.png')
...
function mainapi:CreateCategoryList(categorysettings)
	...
	settings.Image = getcustomasset('pealzware/assets/new/customsettings.png')
...
function mainapi:CreateSearch()
	...
	legiticon.Image = getcustomasset('pealzware/assets/new/legit.png')
...
function mainapi:CreateLegit()
	...
	icon.BackgroundTransparency = 1
	icon.Image = getcustomasset('pealzware/assets/new/legittab.png')
	icon.ImageColor3 = uipallet.Text
	icon.Parent = window
	local close = addCloseButton(window)
	local children = Instance.new('ScrollingFrame')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		notification.Image = getcustomasset('pealzware/assets/new/notification.png')
		...
		iconshadow.Image = getcustomasset('pealzware/assets/new/'..(type or 'info')..'.png')
...
function mainapi:Load(skipgui, profile)
	pcall(function()
		if (inputService.TouchEnabled or shared.FORCE_CREATE_MOBILE_VAPE_BUTTON) and not self.VapeButton then
			...
			image.Image = getcustomasset('pealzware/assets/new/vape.png')
			image.Parent = button
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('pealzware/assets/new/combaticon.png'),
	Size = UDim2.fromOffset(13, 14)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('pealzware/assets/new/blatanticon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('pealzware/assets/new/rendericon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('pealzware/assets/new/utilityicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('pealzware/assets/new/worldicon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Misc',
...
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('pealzware/assets/new/inventoryicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('pealzware/assets/new/miniicon.png'),
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('pealzware/assets/new/friendstab.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('pealzware/assets/new/profilesicon.png'),
...
general:CreateButton({
	...
	Tooltip = 'This will set your profile to the default settings of Pealzware'
})
general:CreateButton({
	Name = 'Self destruct',
	Function = function()
...
--[[guipane:CreateDropdown({
	...
	Function = function(val, mouse)
		if mouse then
			writefile('pealzware/profiles/gui.txt', val)
			shared.vapereload = true
			if shared.VapeDeveloper then
				loadstring(readfile('pealzware/loader.lua'), 'loader')()
			else
				loadstring(game:HttpGet('https://raw.githubusercontent.com/1AreYouMental110/pealzware/'..(isfile('pealzware/profiles/commit.txt') and readfile('pealzware/profiles/commit.txt') or 'main')..'/loader.lua', true))()
			end
		end
	end,
...
textguimoduleslist = textgui:CreateTextList({
	...
	Icon = getcustomasset('pealzware/assets/new/blockedicon.png'),
	Tab = getcustomasset('pealzware/assets/new/blockedtab.png'),
...
VapeLogo.Image = getcustomasset('pealzware/assets/new/textvape.png')
...
VapeLogoV4.Image = getcustomasset('pealzware/assets/new/textv4.png')
...
targetinfoobj = mainapi:CreateOverlay({
	Name = 'Target Info',
	Icon = getcustomasset('pealzware/assets/new/targetinfoicon.png'),
	Size = UDim2.fromOffset(14, 14),
	Position = UDim2.fromOffset(12, 14),
	CategorySize = 240,
	Function = function(callback)
